...
[Register on the partner dashboard](https://merchant.xwift.africa/register) with your name, email, and business name. Pretium emails a password, issues API keys immediately, and gives you 14 days to submit KYB / KYC. See [Onboarding](/onboarding) for sign-in, keys, and the KYB steps.
