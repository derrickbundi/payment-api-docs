...
[Register](https://merchant.xwift.africa/register) on the partner dashboard, [sign in](https://merchant.xwift.africa/login), and copy your **consumer key** from API keys. You will send it as the `x-api-key` header on every partner request.
